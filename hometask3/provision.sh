...
INST_ID=$(aws ec2 run-instances --image-id ami-0b0dcb5067f052a63 --count 1 --instance-type t2.micro --key-name MyKeyPair1 --security-group-ids sg-010f765f16f442e61 --user-data file://user_data.sh --query 'Instances[*].[InstanceId]' --output text) 
